      ...
      <div class="panel-bg">
		...
		<form class="form" id="loginform" method="post" action="<?php echo $base_url;?>welcome/login">
          ...
          <div class="panel-body">
            <div class="login-avatar"><h2>Shoppin</h2><!-- <img src="<?php echo $base_url_views;?>images/logo.jpg" style="margin-left: 55px;" alt="Dealwala">--><br/>
...
<?php }  ?>			</div>
            <div class="form-group">
              <div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span> </span>
                <input type="text" class="form-control" name="txtUserName" id="txtUserName" placeholder="Enter Email Id">
              </div>
            </div>
            <div class="form-group">
		  ...
		  <button type="submit" class="btn btn-sm bg-purple2 pull-right" onclick="javascript:validate();return false;"><i class="fa fa-home"></i> Login</button>
