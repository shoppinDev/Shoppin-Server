  ...
  <section id="content_wrapper">
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
		  <li class="crumb-active"><a href="javascript:void(0);"> Add Register Customer</a></li>
          ...
          <li class="crumb-trail">Add a Register Customer</li>
        </ol>
      </div>
    </div>
    <div id="content">
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Add Register Customer </span> </div>
...
<?php } ?>
    ...
    <div id="validator"  class="alert alert-danger alert-dismissable" style="display:none;">
            ...
            <form role="form" id="form" method="post" action="<?php echo $base_url;?>customer/add" enctype="multipart/form-data">
...
<script>
	function validate(){
		...
		if(username==''){
			...
			$("#error_msg1").html("Please Enter The Customer.");
