  ...
  <section id="content_wrapper">
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
		  <li class="crumb-active"><a href="#"> Edit Customer <?php echo $customer_name;?></a></li>
          <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span class="glyphicon glyphicon-home"></span></a></li>
          <li class="crumb-link"><a href="<?php echo $base_url; ?>customer/lists">Customer</a></li>
    ...
    <div id="content">
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit Customer <?php echo $customer_name;?> </span> </div>
...
<?php } ?>
  ...
  <div class="resp-tabs-container">
    ...
    <div class="static-page-data">
     ...
     <form role="form" id="form" method="post" action="<?php echo $base_url;?>customer/edit/<?php echo $id; ?>" enctype="multipart/form-data" >
	...
	<!--		<div class="form-group">
				...
				-->
					<div class="form-group">
					<label for="inputEmail">Customer Name:<span style="color:red"> *<span></label>
					<div class="">
					  <input type="text" id="username" name="customer_name" class="form-control" value="<?php echo $customer_name;?>">
					</div>
				</div>
				<div class="form-group">
					<label  for="inputEmail">Email:<span style="color:red"> *<span></label>
					<div class="">
					  <input type="text" id="email" name="customer_email" class="form-control" value="<?php echo $customer_email;?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="">
					  <input type="text" id="phone" name="customer_mobile" class="form-control" value="<?php echo $customer_mobile;?>" onkeypress="return numbersonly(event)" maxlength="12">
					</div>
				</div>
				<!--<div class="form-group">
				...
				<?php if($approval!=''){ ?>
					<div class="form-group">
					 	<?php if($is_active=='0' || $is_active=='2')
										...
										<input class="submit btn bg-purple pull-right" id="is_active" name="is_active" type="button" value="Active" onclick="approve('<?php echo $base_url."customer/userstatus/";?><?php echo $id; ?>',1);"/>
                
				  
										<?php }else{ ?>
										  <input class="submit btn bg-purple pull-right" id="is_active" type="button" id="is_active" name="is_active"  value="Inactive" onclick="deapprove('<?php echo $base_url."customer/userstatus/";?><?php echo $id; ?>',0);"/>
										  
										<?php } ?>
				  <a href="<?php echo $base_url;?>customer/lists" class="submit btn bg-purple pull-right" style="margin-right: 10px;" />Cancel</a>
                </div>
...
<script>
	function validate(){
		...
		if(username==''){
			...
			$("#error_msg1").html("Please Enter The Customer Name.");
...
function approve(url,is_approve){
		...
		if(is_approve=='1'){
		 alert('Are you sure you want to Active Register Customer ?');
			window.location.href='<?php echo $base_url ?>/customer/userstatus/<?php echo $id ?>/'+is_approve;		 
			}
		...
		if(is_approve=='0'){
		alert('Are you sure you want to Inactive Register Customer ?');
			window.location.href='<?php echo $base_url ?>/customer/userstatus/<?php echo $id ?>/'+is_approve;	
				} 
