...
<?php }  ?>
		...
		<div class="col-md-12">
			...
			<!--
			<a href="<?php echo $base_url;?>save_deals/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Save Deals</a>-->
		</div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Save Deals Listing </span> </div>
            <div class="panel-body">
			  <form action="<?php echo $base_url."save_deals/deletes";?>" method="post" enctype="multipart/form-data" id="form">
              ...
              <div class="table-responsive">
				...
				?>
				<tr>
					<td><input name="selected[]" id="selected[]" value="<?php echo $result[$i]->save_id ; ?>" type="checkbox"  class="minimal-red"></td>
			
					<td><?php echo $this->save_deals_model->get_customer($result[$i]->customer_id); ?></td>
					<td><?php echo $this->save_deals_model->get_Deals($result[$i]->deal_id); ?></td>
					
				
						<!--
					<td><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url."save_deals/edit/"; ?><?php echo $result[$i]->subcategory_id ; ?>">
					<i class="fa fa-pencil"></i></a></td>
					-->
				</tr>
				<?php
				  } } else {
					  echo 'No Save Deals Found';
				  }
                ?>
...
<script type="text/javascript">
	$(document).ready(function($){
		$('#reset').click(function(){
			var base_url = '<?php echo $base_url.'save_deals/lists'; ?>';
		...
		$.ajax({
		   url:'<?php echo $base_url; ?>save_deals/ajaxlist_country',
		   type:'POST',
		   data:'',
