  ...
  <aside id="sidebar_left">
    <div class="user-info">
      <div class="media"> <a class="pull-left" href="javascript:void(0);">
        <div class="media-object border border-purple br64 bw2 p2"> <img height="40" class="br64" src="<?php echo $base_url_views;?>images/g_logo.png" alt="..."> </div>
        </a>
      ...
      <ul class="nav">
		...
		<li> <a class="accordion-toggle " href="#resources"><span class="glyphicons glyphicons-vcard"></span><span class="sidebar-title">Main Management</span><span class="caret"></span></a>
          <ul id="resources" class="nav sub-nav">
			...
			<li><a class="ajax-disable" href="<?php echo $base_url;?>standardsize/lists"><span class="fa fa-bar-chart"></span>Standard Size</a></li>
			<li class="divider"></li>	
			<?php } ?>
		...
		<li> <a class="accordion-toggle " href="#resources">
				<span class="glyphicons glyphicons-snowflake"></span>
				<span class="sidebar-title">Attributes Management</span><span class="caret"></span>
			</a>
			<ul id="resources" class="nav sub-nav">
		...
		<li> <a class="accordion-toggle " href="#resources">
				<span class="glyphicons glyphicons-snowflake"></span>
				<span class="sidebar-title">Content Management</span><span class="caret"></span>
			</a>
			<ul id="resources" class="nav sub-nav">
			
			 <?php if(in_array('50',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>group_content/lists"><span style="font-size:14px;" class="glyphicon glyphicon-certificate"></span> Group Content </a></li>
			<li class="divider"></li>
			<?php } ?>
				
			 <?php if(in_array('51',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>category_content/lists"><span style="font-size:15px;" class="glyphicon fa fa-male"></span> Category Content </a></li>
			<li class="divider"></li>		
			<?php } ?>
			
			<?php if(in_array('52',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>subcategory_content/lists"><span class="glyphicon glyphicon-list-alt"></span> Subcategory Content </a></li>
			<li class="divider"></li>		
			<?php } ?>
		...
		<li> <a class="accordion-toggle " href="#resources">
				<span class="glyphicons glyphicons-snowflake"></span>
				<span class="sidebar-title">Banner Management</span><span class="caret"></span>
			</a>
			<ul id="resources" class="nav sub-nav">
			
			<?php if(in_array('1',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>position/lists"><span class="glyphicons fa fa-columns"></span> Banner Position Home</a></li>
			<li class="divider"></li>	
			<?php } ?>
			
			 <?php if(in_array('2',$permission1)){ ?>
		     <li><a class="ajax-disable" href="<?php echo $base_url;?>banner/lists"><span class="glyphicons fa fa-stop"></span> Banner Home </a></li>
			<li class="divider"></li>	
			<?php } ?>
			
			<?php if(in_array('58',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>category_banner/lists"><span style="font-size:15px;" class="glyphicon fa fa-male"></span> Category Banner </a></li>
			<li class="divider"></li>		
			<?php } ?>
			
			
			 <?php if(in_array('53',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>banner_catposition/lists"><span style="font-size:14px;" class="glyphicon glyphicon-certificate"></span> Banner Position Saree and Salwar  </a></li>
			<li class="divider"></li>
			<?php } ?>
				
			 <?php if(in_array('54',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>banner_catsaree/lists"><span style="font-size:15px;" class="glyphicon fa fa-male"></span> Banner Saree and Salwar  </a></li>
			<li class="divider"></li>		
			<?php } ?>
			
			<?php if(in_array('55',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>banner_groupposition/lists"><span class="glyphicon glyphicon-list-alt"></span> Banner Position For Others  </a></li>
			<li class="divider"></li>		
			<?php } ?>
			<?php if(in_array('56',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>banner_groupsaree/lists"><span class="glyphicon glyphicon-list-alt"></span> Banner For Others   </a></li>
			<li class="divider"></li>		
			<?php } ?>
		...
		<li> <a class="accordion-toggle " href="#resources">
				...
				<span class="sidebar-title">Shipping Masters</span><span class="caret"></span>
			</a>
			<ul id="resources" class="nav sub-nav">
		...
		<li> <a class="accordion-toggle " href="#resources">
				...
				<span class="sidebar-title"> Offer Management</span><span class="caret"></span>
			</a>
			<ul id="resources" class="nav sub-nav">
				
			 	 <?php if(in_array('26',$permission1)){ ?>
				<li><a class="ajax-disable" href="<?php echo $base_url;?>coupan/lists">	 <span style="font-size:14px;" class="fa fa-building-o"></span>Coupon</a></li><li class="divider"></li> 
				<?php } ?>
		...
		<li> 
			<a class="accordion-toggle " href="#resources"><span class="glyphicons glyphicons-cargo"></span><span class="sidebar-title">Menu Management</span><span class="caret"></span></a>
			<ul id="resources" class="nav sub-nav">
		
			<?php if(in_array('45',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>management/lists"><span class="glyphicons glyphicons-coins"></span>Menu </a></li>
			<li class="divider"></li> 
			<?php } ?>
			<?php if(in_array('57',$permission1)){ ?>
			<li><a class="ajax-disable" href="<?php echo $base_url;?>filter_menu/lists"><span class="glyphicons glyphicons-coins"></span>Filter Menu </a></li>
			<li class="divider"></li> 
			<?php } ?>
		</ul>
        </li>
			<?php if(in_array('46',$permission1)){ ?>
			 <li><a class="ajax-disable" href="<?php echo $base_url;?>flatrate/edit"><span class="glyphicon glyphicon-usd"></span>Currency Management</a></li>
			<li class="divider"></li> 
			<?php } ?>
			
			
		<li> 
			<a class="accordion-toggle " href="#resources"><span class="glyphicons glyphicons-cargo"></span><span class="sidebar-title">Product Master</span><span class="caret"></span></a>
			<ul id="resources" class="nav sub-nav">
				...
				<li class="divider"></li>
				<li><a class="ajax-disable" href="<?php echo $base_url;?>review/product"><span style="font-size:14px;" class="glyphicons glyphicons-group"></span>Product Reviews </a></li>
				 <?php } ?>
