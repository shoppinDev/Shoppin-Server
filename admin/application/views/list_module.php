...
<?php }  ?>
		...
		<div class="col-md-12">
			...
			<a href="<?php echo $base_url;?>module/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Module</a>
		</div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Module Listing </span> </div>
            <div class="panel-body">
			  <form action="<?php echo $base_url."module/deletes";?>" method="post" enctype="multipart/form-data" id="form">
              ...
              <div class="table-responsive">
				...
				?>
				<tr>
					<td><input name="selected[]" id="selected[]" value="<?php echo $result[$i]->module_id; ?>" type="checkbox"  class="minimal-red"></td>
					<td><?php echo $result[$i]->module_name; ?></td>
					<td><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url."module/edit/".$result[$i]->module_id;?>">
...
<script type="text/javascript">
	$(document).ready(function($){
		$('#reset').click(function(){
			var base_url = '<?php echo $base_url.'module/lists'; ?>';
		...
		$.ajax({
		   url:'<?php echo $base_url; ?>module/ajaxlist_country',
		   type:'POST',
		   data:'',
