...
<?php }  ?>
		...
		<div class="col-md-12">
			...
			<a href="<?php echo $base_url;?>category/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Category</a>
		</div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Category Listing </span> </div>
            <div class="panel-body">
              ...
              <div class="table-responsive">
				...
				?>
				<tr>
					<td><input name="selected[]" id="selected[]" value="<?php echo $result[$i]->category_id; ?>" type="checkbox"  class="minimal-red"></td>
					<td><?php echo $result[$i]->category_name; ?></td>
					<td><a class="" title="Edit" href="<?php echo $base_url."category/edit/"; ?><?php echo $result[$i]->category_id; ?>">
