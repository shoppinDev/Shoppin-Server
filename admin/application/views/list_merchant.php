  ...
  <section id="content_wrapper">
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
          <li class="crumb-active"><a href="javascript:void(0);">Merchant</a></li>
          <li class="crumb-icon"><a href="<?php echo $base_url; ?>"><span class="glyphicon glyphicon-home"></span></a></li>         
          <li class="crumb-trail">Merchant</li>
        </ol>
      </div>
    </div>
    <div id="content">
...
<?php }  ?>
		...
		<div class="col-md-12">
		<a href="<?php echo $base_url;?>merchant/download" class="btn btn-alert pull-right"  style="margin-left:10px;background:green;"><i class="fa fa-download"></i> Export To CSV</a>
			...
			<a href="<?php echo $base_url;?>merchant/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Merchant</a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Merchant Listing </span> 
			  
			
			</div>
			
            <div class="panel-body">
			  <form action="<?php echo $base_url."merchant/deletes";?>" method="post" enctype="multipart/form-data" id="form">
              ...
              <div class="table-responsive">
				...
				?>
				<tr>
					<td><input name="selected[]" id="selected[]" value="<?php echo $result[$i]->merchant_id ; ?>" type="checkbox"  class="minimal-red"></td>
					<td><?php echo $result[$i]->merchant_id; ?></td>
					<td><?php echo $result[$i]->merchant_name; ?></td>
					<td><?php echo $result[$i]->merchant_email; ?></td>					
					<td><?php echo $result[$i]->merchant_mobile; ?></td>
				...
				?></td>-->
				<td> 
				<?php if($result[$i]->is_approve=='2')
										{ 
										?>
				<a  title="Pending approval"  href="<?php echo $base_url."merchant/edit/"; ?><?php echo $result[$i]->merchant_id; ?>/deapproval">
											<b><i>Pending approval</i></b>
										</a> 
										<?php }elseif($result[$i]->is_approve=='1')
										{  ?><a  title="Active "  href="<?php echo $base_url."merchant/edit/"; ?><?php echo $result[$i]->merchant_id; ?>/deapproval">
											<p>
<font color="green"><b><i>Active</i></b></font></p>
										</a> 
										<?php }else
										{  ?>
									<a  title="Inactive"  href="<?php echo $base_url."merchant/edit/"; ?><?php echo $result[$i]->merchant_id ?>/deapproval">
											<p>
<font color="red"><b><i>Inactive</i></b></font></p>
									 ...
									 <td><a title="Add Shop" href="<?php echo $base_url."merchant_shops/lists/"; ?><?php echo $result[$i]->merchant_id; ?>">
				         	Manage Shop </a>(<?php echo $this->merchant_model->get_shop_count($result[$i]->merchant_id);?> )</td>
					 <td><?php echo $this->merchant_model->get_deal_count($result[$i]->merchant_id);?></td>
		   ...
		   */
					...
					<td><a class="" title="Edit" href="<?php echo $base_url."merchant/edit/"; ?><?php echo $result[$i]->merchant_id; ?>">
...
function approve(url,is_approve){
	//alert(url);
		...
		//alert(is_approve);
		if(is_approve=='1'){
		var t = confirm('Are you sure you want to Active Register Merchant ?');	
			}
		else if(is_approve=='0'){
		var t = confirm('Are you sure you want to Inactive Register Merchant ?');
				}
			else{
		var t = confirm('Are you sure you want to Pending approval Register Merchant ?');
				}
			if(t){
...
function disapprove(url){
					var t = confirm('Are you sure you want to Disapprove Register Merchant ?');
					if(t){
