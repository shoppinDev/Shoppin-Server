...
<?php }  ?>
		...
		<div class="col-md-12">
		<a href="<?php echo $base_url;?>shop_list/download" class="btn btn-alert pull-right"  style="margin-left:10px;background:green;"><i class="fa fa-download"></i> Export To CSV</a>
		<!--
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-body">
              ...
              <div class="table-responsive">
				...
				<tr>
					...
					<td><?php echo $this->Shop_list_model->get_merchant_name($result[$i]->merchant_id); ?></td>
					<td><?php echo $result[$i]->shop_name; ?></td>
					<td><?php echo $result[$i]->shop_addres; ?></td>					
				...
				<select id="is_approve" name="is_approve" onchange="approve('<?php echo $base_url."merchant/userstatus/";?><?php echo $result[$i]->merchant_id ?>',this.value);" >
				<option value="2"<?php if($result[$i]->is_approve=='2'){ echo 'selected'; } ?>>Pending approval </option>
				<option value="1"<?php if($result[$i]->is_approve=='1'){ echo 'selected'; } ?>>Active</option>
				<option value="0"<?php if($result[$i]->is_approve=='0'){ echo 'selected'; } ?>>Inactive</option>
				</select>
				
				<?php /*
				
									<?php if($result[$i]->is_approve=='0')
										{ 
										?>
												<a class="btn bg-purple2" title="Approved" onclick="approve('<?php echo $base_url."merchant/userstatus/"; ?><?php echo $result[$i]->merchant_id ?>');" href="javascript:void(0);">
											<i>Active</i>
										</a>
										<?php
										}
										...
										{ 
										?>
												<a class="btn bg-purple2" title="Disapproved" onclick="disapprove('<?php echo $base_url."merchant/userstatus/"; ?><?php echo $result[$i]->merchant_id ?>');" href="javascript:void(0)" >
											<i>De-Active</i>
										</a>
										<?php
										} */ ?>
		   ...
		   */
					...
					<!--<td><a class="btn bg-purple2" title="Edit" href="<?php echo $base_url."merchant/edit/"; ?><?php echo $result[$i]->merchant_id; ?>">
...
function approve(url,is_approve){
	//alert(url);
		...
		//alert(is_approve);
		if(is_approve=='1'){
		var t = confirm('Are you sure you want to Approve Register Merchant ?');	
			}
		else if(is_approve=='0'){
		var t = confirm('Are you sure you want to Inapprove Register Merchant ?');
				}
			else{
