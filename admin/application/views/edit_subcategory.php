  ...
  <section id="content_wrapper">
    <div id="topbar">
      <div class="topbar-left">
        <ol class="breadcrumb">
		  <li class="crumb-active"><a href="javascript:void(0);"> Edit Subcategory <?php echo $subcategory_name;?></a></li>
          ...
          <li class="crumb-trail">Edit Subcategory</li>
        </ol>
      </div>
    </div>
    <div id="content">
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-lock"></span> Edit Subcategory <?php echo $subcategory_name;?> </span> </div>
...
<?php }  ?>
    	...
    	<div id="validator"  class="alert alert-danger alert-dismissable" style="display:none;">
            ...
            <form role="form" id="form" method="post" action="<?php echo $base_url;?>subcategory/edit/<?php echo $subcategory_id; ?>" enctype="multipart/form-data" >
 				
			<INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
			<INPUT TYPE="hidden" NAME="action" VALUE="edit_subcategory">
			<INPUT TYPE="hidden" NAME="hiddenaction" VALUE="<?php echo $subcategory_id;?>">
				...
				{
				?>
				<option value='<?php echo $allcategorylist[$i]->category_id; ?>' <?php if($allcategorylist[$i]->category_id==$category_id){echo 'selected';}?>>
                ...
                <div class="form-group">
                  ...
                  <input id="subcategoryname" name="subcategory_name" type="text" class="form-control" placeholder="Enter Subcategory Name" required value="<?php echo $subcategory_name; ?>" />
                </div>
