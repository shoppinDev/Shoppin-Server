...
<?php }  ?>
		...
		<div class="col-md-12">
			...
			<a href="<?php echo $base_url;?>role/add/" class="btn btn-alert pull-right"><i class="fa fa-plus"></i> Add Role</a>
		</div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading"> <span class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span> Role Listing </span> </div>
            <div class="panel-body">
			  <form action="<?php echo $base_url."role/deletes";?>" method="post" enctype="multipart/form-data" id="form">
              ...
              <div class="table-responsive">
				...
				?>
				<tr>
					<td><input name="selected[]" id="selected[]" value="<?php echo $result[$i]->role_id; ?>" type="checkbox"  class="minimal-red"></td>
					<td><?php echo $result[$i]->role_name; ?></td>
					<td><a class="" title="Edit" href="<?php echo $base_url."role/edit/"; ?><?php echo $result[$i]->role_id; ?>">
...
<script type="text/javascript">
	$(document).ready(function($){
		$('#reset').click(function(){
			var base_url = '<?php echo $base_url.'role/lists'; ?>';
		...
		$.ajax({
		   url:'<?php echo $base_url; ?>role/ajaxlist_country',
		   type:'POST',
		   data:'',
